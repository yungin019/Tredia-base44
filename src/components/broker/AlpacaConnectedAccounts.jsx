        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-white/40 mt-0.5">
              {isConnected ? 'Live trading active via Alpaca Securities' : 'Connect your Alpaca account to trade directly from TREDIO'}
            </p>
          </div>
        </div>
          ...
          <>
            {user?.alpaca_account_id && (
              <div className="mb-4 p-3 rounded-lg" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
                <p className="text-[10px] text-white/30 mb-0.5 uppercase tracking-wider">Account ID</p>
            ...
            <p className="text-[10px] text-white/30 mb-3 leading-relaxed">
              Revoking access will disable live trading from TREDIO. Paper trading and signals remain available.
            </p>
            <button
          ...
          <>
            ...
            <div className="mb-4 p-3 rounded-lg flex items-start gap-2.5" style={{ background: 'rgba(245,158,11,0.06)', border: '1px solid rgba(245,158,11,0.15)' }}>
              ...
              <p className="text-[10px] text-white/50 leading-relaxed">
                TREDIO provides AI-powered trading signals. Order execution is handled through your Alpaca brokerage account.
                You'll authorize TREDIO to read your portfolio and place trades on your behalf.
              </p>
            </div>
            ...
            <p className="text-[10px] text-white/25 text-center">
              You'll be taken to Alpaca to log in or create a free account.
            </p>
          </>
        )}
      </div>
