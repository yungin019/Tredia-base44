...
const ALL_REACTIONS = [
  ...
  {
    id: 'fed-pause',
    marketState: 'QQQ broke $420 resistance as traders price in the end of rate hikes. Bond yields dropped 8-10bp in two days.',
    regions: ['US'],
    timing: 'Live',
    driver: 'Three Fed governors signaled no more rate hikes this cycle; futures repriced from 2% terminal rate to 1.75%',
    impact: 'Growth stocks rally hardest—NVDA +2.5%, AAPL +1.8%, SPY flat. Long-duration bonds (TLT) leading. Dollar weakness (-0.6% DXY).',
    watch_next: 'Watch for: PCE inflation print Friday (if hot >3.2%, all this reverses). Fed Chair Powell speech Thursday—key for confirmation.',
    related_assets: ['NVDA', 'AAPL', 'QQQ', 'TLT', 'SPY'],
    direction: 'bullish',
    importance: 9,
    action_bias: 'bullish',
    confidence: 82,
    headline: 'Fed Signals End of Rate Hike Cycle',
    source_name: 'Federal Reserve',
    source_url: null,
    category: 'central_bank',
    risk: 'PCE inflation surprises >3.2% OR Fed walks back pause comments = immediate reversal',
    regions: ['US'],
  },
  {
    id: 'nvidia-earnings',
    marketState: 'NVDA jumped $8 in pre-market after beating earnings by 12% on AI data center revenue. Semis are rallying on confirmation that hyperscaler capex is real.',
    regions: ['US'],
    timing: 'Developing',
    driver: 'NVDA reported $18.1B data center revenue (vs. $16.9B expected). Management raised full-year guidance to $120B from $110B. Backlog remains massive.',
    impact: 'AMD up 3.2%, SMCI up 4.1%, TSM up 2.8% in after-hours. QQQ outperforming SPY by 180bp. Puts pressure on mega-cap growth (not just semis).',
    watch_next: 'Watch AMD earnings next week—if they also beat, semis are confirmed breakout. Monitor TSM Taiwan factory updates. Key level: NVDA $180 (former resistance).',
    related_assets: ['NVDA', 'AMD', 'SMCI', 'TSM', 'QQQ'],
    direction: 'bullish',
    importance: 8,
    action_bias: 'bullish',
    confidence: 85,
    headline: 'NVIDIA Crushes Earnings, Raises Full-Year Guidance',
    source_name: 'Earnings Release',
    source_url: null,
    category: 'earnings',
    risk: 'If AMD misses next week OR capex guidance cuts from MSFT/GOOG, pyramid unwinds fast',
    regions: ['US'],
  },
  {
    id: 'us-jobs-strong',
