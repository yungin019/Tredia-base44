...
export default function TrendingAssets({ stocks = [] }) {
  ...
  // Only show assets that have live data
  const assets = stocks.filter(s => s.price && s.price > 0);

  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-[11px] font-bold text-white/50 uppercase tracking-[0.12em]">Live Assets</h3>
