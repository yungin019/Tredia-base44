    ...
    <div className="min-h-screen bg-[#0A0A0F] flex flex-col grid-bg">
      ...
      <header className="glass-dark border-b border-white/[0.06] px-4 lg:px-6 flex items-center justify-between sticky top-0 z-50"
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Back button ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ visible when inside a sub-page */}
          {showBack ? (
            <button
              onClick={goBack}
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setSearchOpen(true)}
            ...
            <kbd className="text-[9px] bg-white/[0.06] px-1.5 py-0.5 rounded font-mono ml-2">ÃÂÃÂ¢ÃÂÃÂÃÂÃÂK</kbd>
          </button>
          <button onClick={() => setSearchOpen(true)}
