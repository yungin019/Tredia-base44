...
const translations = {
  ...
  en: {
    translation: {
      ...
      portfolio: { title: "Portfolio", subtitle: "Your holdings and performance", noHoldings: "No holdings yet. Add your first position.", empty: "Your portfolio is empty", contextTitle: "Your Portfolio 📈", contextBody: "Here you track all your positions. P&L shows your profit or loss. The TREK grade tells you how healthy your portfolio is. Ask me anything about what you see.", contextAnalyze: "Analyze my portfolio", contextAddFirst: "Add my first position", contextAI: "Explain P&L, portfolio allocation, and risk in simple terms. I'm a beginner.", totalValue: "Total Value", totalPnL: "Total P&L", return: "Return", allocation: "Allocation", holdings: "Holdings", tradeHistory: "Trade History", performance: "Performance", noPositions: "No positions yet", noPositionsDesc: "Track your investments here. Add a holding manually or simulate trades with paper trading.", addFirstPosition: "Add First Position", startPaperTrading: "Start Paper Trading", symbol: "Symbol", shares: "Shares", avgCost: "Avg Cost", current: "Current", marketValue: "Market Value", pnl: "P&L" },
      ...
      common: { loading: "Loading...", error: "Error", success: "Success", emptyState: "No data available", tryAgain: "Try Again", notAvailable: "Not available", impact: "Impact", trade: "Trade", add: "Add" }
    }
  },
  sv: {
     translation: {
       ...
       portfolio: { title: "Portfölj", subtitle: "Dina innehav och prestanda", noHoldings: "Inga innehav ännu. Lägg till din första position.", empty: "Din portfölj är tom", contextTitle: "Din portfölj 📈", contextBody: "Här spårar du alla dina positioner. P&L visar din vinst eller förlust. TREK-graden talar om hur hälsosam din portfölj är. Ställ mig vilken fråga som helst om det du ser.", contextAnalyze: "Analysera min portfölj", contextAddFirst: "Lägg till min första position", contextAI: "Förklara P&L, portföljallokering och risk på enkla termer. Jag är nybörjare.", totalValue: "Totalt värde", totalPnL: "Total P&L", return: "Avkastning", allocation: "Allokering", holdings: "Innehav", tradeHistory: "Handelshistorik", performance: "Prestanda", noPositions: "Inga positioner ännu", noPositionsDesc: "Spåra dina investeringar här. Lägg till ett innehav manuellt eller simulera affärer med papperhandel.", addFirstPosition: "Lägg till första position", startPaperTrading: "Starta papperhandel", symbol: "Symbol", shares: "Aktier", avgCost: "Medelpris", current: "Aktuell", marketValue: "Marknadsvärde", pnl: "P&L" },
       ...
       home: { alerts: "Varningar", timeSensitive: "Tidskänsliga", allSignals: "Alla signaler", forYou: "För dig", basedOnPortfolio: "Baserat på din portfölj", seeAll: "Se alla", recommended: "Rekommenderade tillgångar", topOpportunities: "Bästa AI-möjligheter", viewMarkets: "Visa marknader", latestJumps: "Senaste hopp", strongSignals: "Starka uppåtsignaler", riskWarnings: "Riskvarningar", assetsToAvoid: "Tillgångar att minska eller undvika", marketNews: "Marknadsnyheter", aiAnalyzed: "AI-analyserat", contextTitle: "Välkommen till TREDIA ⚡", contextBody: "Det här är ditt kommandocenter. Varningar rankas efter brådskande, signaler är AI-drivna och nyheter analyseras för marknadseffekt. Jag är här för att vägleda dig.", contextAction: "Vad bör jag fokusera på idag?", contextAI: "Jag öppnade precis TREDIA. Vad bör jag fokusera på idag? Ge mig en snabb genomgång.", trekInsight: "Marknader i", territory: "terr. AI detekterar institutionell ackumulering i halvledare.", aiDetects: "AI detekterar institutionell ackumulering i halvledare.", vixFlag: "VIX-termstruktur flaggad — skydda öppna positioner.", bestSetup: "🟢 Bästa setup", biggestRisk: "🔴 Största risk", sentiment: "📊 Sentiment", alert: { nvda: "Momentumgenombrott bekräftad. Entry $871. Mål $942.", vix: "Termstrukturinversion. Minska aktieexponering nu.", meta: "Baissiv divergens dagligen. 78% konfidens." }, foryou: { nvda: "Passar din momentumprofil. Högt förtroende.", jpm: "Balanserar din 38% teknikexponering.", btc: "Överensstämmer med ditt kryptotilldelingsmål." }, jumps: { smci: "AI-serversförfrågan ökar", arm: "Mobil AI-chiprcykel", pltr: "Regeringskontrakt vunnet", sofi: "Analytiker uppgradering + priser" }, warnings: { tsla: "Volym torkar ut. Bryt under $165 = kaskad till $145.", meta: "Baissiv divergens dagligen RSI. Svag relativ styrka.", rivn: "Kassabränning accelererar. Undvik nya positioner." }, news: { fed: { headline: "Fed signalerar paus — marknader stiger på räntesänkningshopp", summary: "Powell hints vid möjliga räntesänkningar i H2 2025 när inflationen svalnar mot 2% mål. S&P 500 stiger 1,4%." }, nvda: { headline: "NVIDIA datacenterintäkter slår uppskattningar med 18%", summary: "AI-chipefterfrågning fortsätter att överträffa tillgången. NVDA höjde FY2025-vägledning över analytikerkonsensus." }, china: { headline: "Kinas teknikkrasch återuppstår — ADR-er faller", summary: "Regelkrav på kinesiska teknikföretag förnyar bekymmer. BABA, JD, PDD alla ner 3–5% förmarknad." }, bitcoin: { headline: "Bitcoin bryter $68K när institutionella flöden accelererar", summary: "Spot BTC ETF-inflöden når $900M på en enda dag. On-chain data visar valöverslagring på nuvarande nivåer." } } },
       common: { loading: "Laddar...", error: "Fel", success: "Framgång", emptyState: "Ingen data tillgänglig", tryAgain: "Försök igen", notAvailable: "Inte tillgänglig", impact: "Påverkan" }
       }
       },
  fr: {
     translation: {
       ...
       portfolio: { title: "Portefeuille", subtitle: "Vos positions et performances", noHoldings: "Aucune position pour le moment. Ajoutez votre première position.", empty: "Votre portefeuille est vide", contextTitle: "Votre Portefeuille 📈", contextBody: "Ici, vous suivez toutes vos positions. P&L montre votre profit ou perte. La note TREK vous indique la santé de votre portefeuille. Posez-moi n'importe quelle question sur ce que vous voyez.", contextAnalyze: "Analyser mon portefeuille", contextAddFirst: "Ajouter ma première position", contextAI: "Expliquez P&L, allocation de portefeuille et risque en termes simples. Je suis débutant.", totalValue: "Valeur totale", totalPnL: "P&L total", return: "Rendement", allocation: "Allocation", holdings: "Avoirs", tradeHistory: "Historique des échanges", performance: "Performance", noPositions: "Aucune position pour le moment", noPositionsDesc: "Suivez vos investissements ici. Ajoutez un avoir manuellement ou simulez des transactions avec le trading papier.", addFirstPosition: "Ajouter la première position", startPaperTrading: "Démarrer le trading papier", symbol: "Symbole", shares: "Parts", avgCost: "Coût moyen", current: "Courant", marketValue: "Valeur de marché", pnl: "P&L" },
       ...
       home: { alerts: "Alertes", timeSensitive: "Temps sensible", allSignals: "Tous les signaux", forYou: "Pour vous", basedOnPortfolio: "Basé sur votre portefeuille", seeAll: "Voir tout", recommended: "Actifs recommandés", topOpportunities: "Meilleures opportunités IA", viewMarkets: "Voir les marchés", latestJumps: "Derniers sauts", strongSignals: "Signaux forts à la hausse", riskWarnings: "Avertissements de risque", assetsToAvoid: "Actifs à réduire ou à éviter", marketNews: "Actualités du marché", aiAnalyzed: "Analysé par l'IA", contextTitle: "Bienvenue sur TREDIA ⚡", contextBody: "Ceci est votre centre de commande. Les alertes sont classées par urgence, les signaux sont générés par l'IA et les actualités sont analysées pour l'impact du marché. Je suis là pour vous guider.", contextAction: "Sur quoi devrais-je me concentrer aujourd'hui?", contextAI: "Je viens d'ouvrir TREDIA. Sur quoi devrais-je me concentrer aujourd'hui? Donnez-moi un aperçu rapide.", trekInsight: "Les marchés sont en", territory: "terr. L'IA détecte l'accumulation institutionnelle dans les semi-conducteurs.", aiDetects: "L'IA détecte l'accumulation institutionnelle dans les semi-conducteurs.", vixFlag: "Structure de terme VIX signalée — protégez les positions ouvertes.", bestSetup: "🟢 Meilleure configuration", biggestRisk: "🔴 Plus grand risque", sentiment: "📊 Sentiment", alert: { nvda: "Percée momentum confirmée. Entry $871. Cible $942.", vix: "Inversion de la structure à terme. Réduisez l'exposition aux actions maintenant.", meta: "Divergence baissière quotidienne. 78% de confiance." }, foryou: { nvda: "Correspond à votre profil momentum. Conviction élevée.", jpm: "Équilibre votre exposition technologique de 38%.", btc: "Aligne avec votre cible d'allocation crypto." }, jumps: { smci: "Demande accrue de serveurs IA", arm: "Cycle de puces AI mobile", pltr: "Contrat gouvernemental remporté", sofi: "Amélioration des analystes + taux" }, warnings: { tsla: "Volume qui s'assèche. Casse sous $165 = cascade à $145.", meta: "Divergence baissière RSI quotidienne. Force relative faible.", rivn: "Brûlure de trésorerie en accélération. Évitez les nouvelles positions." }, news: { fed: { headline: "La Fed signale une pause — les marchés se rallient sur l'espoir de réductions de taux", summary: "Powell suggère d'éventuelles baisses de taux au S2 2025 alors que l'inflation se refroidit vers une cible de 2%. S&P 500 gagne 1,4%." }, nvda: { headline: "Les revenus de NVIDIA dans les centres de données dépassent les estimations de 18%", summary: "La demande en puces IA continue de dépasser l'offre. NVIDIA a relevé les prévisions FY2025 au-dessus du consensus des analystes." }, china: { headline: "La répression technologique de la Chine refait surface — les ADR chutent", summary: "La pression réglementaire sur les entreprises technologiques chinoises renouvelle les préoccupations. BABA, JD, PDD tous en baisse de 3–5% avant la séance." }, bitcoin: { headline: "Bitcoin dépasse $68K alors que les flux institutionnels s'accélèrent", summary: "Les entrées de BTC ETF spot atteignent $900M en une seule journée. Les données on-chain montrent une accumulation de baleine aux niveaux actuels." } } },
       common: { loading: "Chargement...", error: "Erreur", success: "Succès", emptyState: "Aucune donnée disponible", tryAgain: "Réessayer", notAvailable: "Non disponible", impact: "Impact" }
       }
       },
  ar: {
     translation: {
