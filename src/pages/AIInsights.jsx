...
const PREDEFINED_SIGNALS = [
  {
    ...
    technicals: [
      ...
      { label: 'MACD', value: 'Cross↑', signal: 'bull' },
  ...
  },
  {
    ...
    evidence: [
      ...
      { label: 'Breadth Deterioration', value: 'A/D Line ↓', score: 72 },
    ...
    technicals: [
      ...
      { label: 'VIX', value: '14.2↑', signal: 'bear' },
  ...
  },
  {
    ...
    evidence: [
      ...
      { label: 'Short Interest ΔΔ', value: '+0.8% WoW', score: 62 },
    ],
    risks: [
  ...
  },
  {
    ...
    risks: [
      'China sales remain under pressure (-6% YoY last quarter) — key risk to guidance.',
  ...
  },
  {
    ...
    evidence: [
      ...
      { label: 'P/E vs Historical', value: '11.2× (cheap)', score: 72 },
    ],
    risks: [
    ...
    technicals: [
      ...
      { label: 'EMA 50', value: 'Above', signal: 'bull' },
      { label: 'Yield 10Y', value: '4.34% ↑', signal: 'bull' },
      { label: 'P/E', value: '11.2×', signal: 'bull' },
    ],
  },
];
